...
TEMP_DB_PATH = Path(TEMP_DIR) / "test_ast_cache.db"
...
async def test_circular_inheritance():
    ...
    # In circular inheritance, BChild inherits from AChild which is complete,
    # so that inheritance link should be successfully captured.
    has_a_base = False
    for sym in res_b:
