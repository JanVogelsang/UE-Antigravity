...
#define LOCTEXT_NAMESPACE "AntigravitySequencerActions"

// ============================================================================
// Lifecycle
// ============================================================================

FAntigravitySequencerActions::FAntigravitySequencerActions() {}
FAntigravitySequencerActions::~FAntigravitySequencerActions() {}
...
FAntigravityActionResult FAntigravitySequencerActions::ExecuteCreateLevelSequence(
...
FAntigravityActionResult FAntigravitySequencerActions::ExecuteAddSequencerTrack(
	const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	FString AssetPath;
	if (!Params->TryGetStringField(TEXT("asset_path"), AssetPath))
...
FAntigravityActionResult FAntigravitySequencerActions::ExecuteAddSequencerKeyframe(
	const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	FString AssetPath;
	if (!Params->TryGetStringField(TEXT("asset_path"), AssetPath))
