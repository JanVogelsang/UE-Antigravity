...
#define LOCTEXT_NAMESPACE "AntigravityDataTableActions"

// ============================================================================
// Lifecycle
// ============================================================================

FAntigravityDataTableActions::FAntigravityDataTableActions() {}
FAntigravityDataTableActions::~FAntigravityDataTableActions() {}
...
FAntigravityActionResult FAntigravityDataTableActions::ExecuteCreateDataTable(
...
FAntigravityActionResult FAntigravityDataTableActions::ExecuteImportJsonToDataTable(
	const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	FString AssetPath;
	if (!Params->TryGetStringField(TEXT("asset_path"), AssetPath))
