 ...
 */
class ANTIGRAVITYACTIONS_API FAntigravityBlueprintActions : public IAntigravityActionExecutor
{
public:
	FAntigravityBlueprintActions();
	virtual ~FAntigravityBlueprintActions();
...
private:
	...
	FAntigravityActionResult ExecuteCreateBlueprint(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result);

	/** Add a component to an existing Blueprint via the Simple Construction Script. */
	FAntigravityActionResult ExecuteAddComponent(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result);

	/** Add a typed member variable to a Blueprint. */
	FAntigravityActionResult ExecuteAddVariable(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result);

	/** Compile a Blueprint and return all errors/warnings. */
	FAntigravityActionResult ExecuteCompileBlueprint(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result);
	 ...
	 */
	FAntigravityActionResult ExecuteInjectNodesT3D(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result);
	 ...
	 */
	FAntigravityActionResult ExecuteAddFunction(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result);
	 ...
	 */
	FAntigravityActionResult ExecuteSetComponentProperties(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result);
	 ...
	 */
	FAntigravityActionResult ExecuteAddEventHandler(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result);
	 ...
	 */
	FAntigravityActionResult ExecuteConnectPins(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result);
	 ...
	 */
	FAntigravityActionResult ExecuteAddEnhancedInputNode(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result);
	 ...
	 */
	FAntigravityActionResult ExecuteVerifyConnections(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result);
	 ...
	 */
	FAntigravityActionResult ExecuteSetNodePinDefault(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result);
	 ...
	 */
	FAntigravityActionResult ExecuteBatchOperations(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result);
