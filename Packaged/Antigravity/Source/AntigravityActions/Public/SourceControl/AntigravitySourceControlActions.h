...
class ANTIGRAVITYACTIONS_API FAntigravitySourceControlActions : public IAntigravityActionExecutor
{
public:
    FAntigravitySourceControlActions();
    virtual ~FAntigravitySourceControlActions();
