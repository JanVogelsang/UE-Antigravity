...
class ANTIGRAVITYACTIONS_API FAntigravityPerformanceActions : public IAntigravityActionExecutor
{
public:
    FAntigravityPerformanceActions();
    virtual ~FAntigravityPerformanceActions();
