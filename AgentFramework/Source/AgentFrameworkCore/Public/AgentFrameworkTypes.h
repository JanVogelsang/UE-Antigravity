...
#include "AgentFrameworkTypes.generated.h"
...
/** Security mode controlling what actions AgentFramework is allowed to perform */
UENUM(BlueprintType)
enum class EAgentFrameworkSecurityMode : uint8
{
...
struct AGENTFRAMEWORKCORE_API FAgentFrameworkToolCall
{
	GENERATED_BODY()

	/** The unique tool call ID from AgentFramework/Gemini */
	...
	FAgentFrameworkToolCall() = default;
};
...
USTRUCT(BlueprintType)
struct AGENTFRAMEWORKCORE_API FAgentFrameworkActionResult
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct AGENTFRAMEWORKCORE_API FAgentFrameworkFileEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct AGENTFRAMEWORKCORE_API FAgentFrameworkAssetEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct AGENTFRAMEWORKCORE_API FAgentFrameworkEditorContext
{
	GENERATED_BODY()
