...
/**
 * FAgentFrameworkPythonActions
 *
 * Provides the execute_python_script tool â€” the "escape hatch" that gives the AI
 ...
 *   - Temp scripts are written to Saved/AgentFramework/Scripts/ and cleaned up after
 ...
 */
class AGENTFRAMEWORKACTIONS_API FAgentFrameworkPythonActions : public IAgentFrameworkActionExecutor
{
public:
	FAgentFrameworkPythonActions();
	virtual ~FAgentFrameworkPythonActions();
...
private:
	 ...
	 *
	 * 1. Writes script to temp file in Saved/AgentFramework/Scripts/
	 ...
	 */
	FAgentFrameworkActionResult ExecutePythonScript(const TSharedRef<FJsonObject>& Params, FAgentFrameworkActionResult& Result);
	...
	/** Get the temp scripts directory (Saved/AgentFramework/Scripts/) */
