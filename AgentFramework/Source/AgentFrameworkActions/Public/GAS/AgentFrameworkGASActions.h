 ...
 */
class AGENTFRAMEWORKACTIONS_API FAgentFrameworkGASActions : public IAgentFrameworkActionExecutor
{
public:
	FAgentFrameworkGASActions();
	virtual ~FAgentFrameworkGASActions();
...
private:
	 ...
	 */
	FAgentFrameworkActionResult ExecuteRegisterTags(const TSharedRef<FJsonObject>& Params, FAgentFrameworkActionResult& Result);
	 ...
	 */
	FAgentFrameworkActionResult ExecuteCreateAttributeSet(const TSharedRef<FJsonObject>& Params, FAgentFrameworkActionResult& Result);
	 ...
	 */
	FAgentFrameworkActionResult ExecuteSetupASC(const TSharedRef<FJsonObject>& Params, FAgentFrameworkActionResult& Result);
	 ...
	 */
	FAgentFrameworkActionResult ExecuteCreateEffect(const TSharedRef<FJsonObject>& Params, FAgentFrameworkActionResult& Result);
	 ...
	 */
	FAgentFrameworkActionResult ExecuteCreateAbility(const TSharedRef<FJsonObject>& Params, FAgentFrameworkActionResult& Result);
};
