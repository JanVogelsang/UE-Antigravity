 ...
 */
class ANTIGRAVITYACTIONS_API FAntigravityPythonActions : public IAntigravityActionExecutor
{
public:
	FAntigravityPythonActions();
	virtual ~FAntigravityPythonActions();
...
private:
	 ...
	 *
	 * 1. Writes script to temp file in Saved/Antigravity/Scripts/
	 ...
	 */
	FAntigravityActionResult ExecutePythonScript(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result);
	...
	/** Get the temp scripts directory (Saved/Antigravity/Scripts/) */
