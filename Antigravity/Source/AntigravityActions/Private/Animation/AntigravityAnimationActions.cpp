...
bool FAntigravityAnimationActions::ValidateParams(const TSharedRef<FJsonObject>& Params, TArray<FString>& OutErrors) const
{
...
FAntigravityActionResult FAntigravityAnimationActions::ExecuteAction(const TSharedRef<FJsonObject>& Params)
{
...
FAntigravityActionResult FAntigravityAnimationActions::ExecuteCreateAnimBlueprint(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	...
	UE_LOG(LogAntigravity, Log, TEXT("AnimationActions: Created AnimBP '%s' targeting skeleton '%s'"), *AssetPath, *SkeletonPath);
...
FAntigravityActionResult FAntigravityAnimationActions::ExecuteImportAnimationFBX(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
...
FAntigravityActionResult FAntigravityAnimationActions::ExecuteAssignAnimBlueprint(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	FString AssetPath      = Params->GetStringField(TEXT("asset_path"));
...
FAntigravityActionResult FAntigravityAnimationActions::ExecuteCreateAnimMontage(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	FString AssetPath    = Params->GetStringField(TEXT("asset_path"));
	FString SkeletonPath = Params->GetStringField(TEXT("skeleton_path"));
...
FAntigravityActionResult FAntigravityAnimationActions::ExecuteGetAnimInfo(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	FString AssetPath = Params->GetStringField(TEXT("asset_path"));
