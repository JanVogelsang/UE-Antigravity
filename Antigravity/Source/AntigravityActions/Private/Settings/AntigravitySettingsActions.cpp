...
bool FAntigravitySettingsActions::ValidateParams(const TSharedRef<FJsonObject>& Params, TArray<FString>& OutErrors) const
{
	FString ToolName;
...
FAntigravityActionResult FAntigravitySettingsActions::ExecuteAction(const TSharedRef<FJsonObject>& Params)
{
	...
	{
		Transaction.Emplace(FText::FromString(TEXT("Antigravity Settings Action")));
	}
