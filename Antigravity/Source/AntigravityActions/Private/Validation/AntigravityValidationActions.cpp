...
#define LOCTEXT_NAMESPACE "AntigravityValidationActions"

// ============================================================================
// Lifecycle
// ============================================================================

FAntigravityValidationActions::FAntigravityValidationActions() {}
FAntigravityValidationActions::~FAntigravityValidationActions() {}
...
FAntigravityActionResult FAntigravityValidationActions::ExecuteValidateAssets(
	const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	...
	// Run validation
	UE_LOG(LogAntigravity, Log, TEXT("ValidationActions: Validating %d assets..."), AssetsToValidate.Num());
...
FAntigravityActionResult FAntigravityValidationActions::ExecuteRunAutomationTests(
	const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	FString TestFilter;
	...
	{
		Params->TryGetBoolField(TEXT("list_only"), bRunTests);
		bRunTests = !bRunTests; // list_only = true â†’ don't run
	}

	if (bRunTests)
	{
		// Execute tests via console command â€” the most reliable cross-version method
