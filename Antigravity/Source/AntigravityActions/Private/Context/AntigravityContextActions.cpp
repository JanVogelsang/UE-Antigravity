...
bool FAntigravityContextActions::IsPathSafe(const FString& RelativePath) const
{
...
FAntigravityActionResult FAntigravityContextActions::ExecuteListDirectory(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	FString RelativeDir;
...
FAntigravityActionResult FAntigravityContextActions::ExecuteReadFileSnippet(const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	FString FilePath;
