...
#define LOCTEXT_NAMESPACE "AntigravityPIEActions"

// ============================================================================
// Lifecycle
// ============================================================================

FAntigravityPIEActions::FAntigravityPIEActions() {}
FAntigravityPIEActions::~FAntigravityPIEActions() {}
...
FName FAntigravityPIEActions::GetActionName() const { return FName(TEXT("PIE")); }
FText FAntigravityPIEActions::GetDisplayName() const { return LOCTEXT("DisplayName", "Play-In-Editor Testing"); }
EAntigravityActionCategory FAntigravityPIEActions::GetCategory() const { return EAntigravityActionCategory::General; }
EAntigravityRiskLevel FAntigravityPIEActions::GetDefaultRiskLevel() const { return EAntigravityRiskLevel::High; }
bool FAntigravityPIEActions::CanUndo() const { return false; }
bool FAntigravityPIEActions::UndoAction() { return false; }

TArray<FString> FAntigravityPIEActions::GetSupportedToolNames() const
{
	return {
...
bool FAntigravityPIEActions::ValidateParams(const TSharedRef<FJsonObject>& Params, TArray<FString>& OutErrors) const
{
	return true;
}

FAntigravityActionPlan FAntigravityPIEActions::PreviewAction(const TSharedRef<FJsonObject>& Params)
{
	...
	A.RiskLevel = EAntigravityRiskLevel::High;
	Plan.Actions.Add(A);
	return Plan;
}

FAntigravityActionResult FAntigravityPIEActions::ExecuteAction(const TSharedRef<FJsonObject>& Params)
{
...
FAntigravityActionResult FAntigravityPIEActions::ExecuteStartPIE(
	const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	...
	UE_LOG(LogAntigravity, Log, TEXT("PIEActions: Requested PIE session start."));
...
FAntigravityActionResult FAntigravityPIEActions::ExecuteSimulateInput(
	const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	if (!IsPIERunning())
	{
...
FAntigravityActionResult FAntigravityPIEActions::ExecuteStopPIE(
	const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	if (!IsPIERunning())
	{
	...
	if (GUnrealEd)
	{
		...
		UE_LOG(LogAntigravity, Log, TEXT("PIEActions: Requested PIE session stop."));
	}
...
bool FAntigravityPIEActions::IsPIERunning()
{
