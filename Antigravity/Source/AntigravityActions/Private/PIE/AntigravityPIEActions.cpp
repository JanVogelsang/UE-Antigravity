...
FAntigravityActionResult FAntigravityPIEActions::ExecuteExtractUIState(
	const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	if (!IsPIERunning())
	{
...
FAntigravityActionResult FAntigravityPIEActions::ExecuteTriggerUIElement(
	const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	if (!IsPIERunning())
	{
...
FAntigravityActionResult FAntigravityPIEActions::ExecuteQueryWorldState(
	const TSharedRef<FJsonObject>& Params, FAntigravityActionResult& Result)
{
	if (!IsPIERunning())
	{
