 ...
 */
struct ANTIGRAVITYENGINE_API FAntigravitySearchMatch
{
	/** Relative file path */
	FString FilePath;
 ...
 */
struct ANTIGRAVITYENGINE_API FAntigravitySearchResult
{
	/** Whether the search succeeded */
	bool bSuccess = false;

	/** All matches found */
	TArray<FAntigravitySearchMatch> Matches;
 ...
 *
 * Roo Code uses the `rg` binary for fast regex searching. Antigravity implements
 ...
 *   FAntigravityFileSearchService Svc;
 *   FAntigravitySearchResult R = Svc.SearchFiles(
 *       FPaths::ProjectDir(),
 *       TEXT("Source/"),
 *       TEXT("TODO.*Optimize"),
 *       TEXT("*.cpp")
 ...
 */
class ANTIGRAVITYENGINE_API FAntigravityFileSearchService
{
public:
	 ...
	 */
	FAntigravitySearchResult SearchFiles(
