...
#include "AntigravityProjectContext.h"

class ANTIGRAVITYENGINE_API FAntigravityContextGatherer : public IAntigravityContextGatherer
{
public:
	FAntigravityContextGatherer();
	virtual ~FAntigravityContextGatherer();
	...
	FAntigravityProjectContext BuildProjectContext();

private:
	FAntigravityProjectContext CachedContext;
