 ...
 */
struct ANTIGRAVITYENGINE_API FAntigravitySearchReplaceBlock
{
	...
	FAntigravitySearchReplaceBlock() = default;
	FAntigravitySearchReplaceBlock(const FString& InSearch, const FString& InReplace)
 ...
 */
struct ANTIGRAVITYENGINE_API FAntigravityDiffApplyResult
{
 ...
 *
 * Usage:
 *   FAntigravityDiffApplicator Applicator;
 *   FAntigravityDiffApplyResult Result = Applicator.ApplyDiff(OriginalContent, DiffText);
 *   if (Result.bSuccess) { WriteFile(Result.ResultContent); }
 */
class ANTIGRAVITYENGINE_API FAntigravityDiffApplicator
{
public:
	 ...
	 */
	FAntigravityDiffApplyResult ApplyDiff(
	 ...
	 * @return                 Result with success/failure and result content
	 */
	FAntigravityDiffApplyResult ApplyBlocks(
		const FString& OriginalContent,
	 ...
	 */
	static bool ParseDiffBlocks(const FString& DiffText, TArray<FAntigravitySearchReplaceBlock>& OutBlocks);
...
private:
	 ...
	 */
	FAntigravityDiffApplyResult ApplySingleBlock(
		FString& Content,
