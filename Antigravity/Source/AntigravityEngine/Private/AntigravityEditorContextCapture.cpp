...
#include "AntigravityEditorContextCapture.h"
...
FAntigravityEditorContextCapture::FAntigravityEditorContextCapture() {}
FAntigravityEditorContextCapture::~FAntigravityEditorContextCapture() {}

FAntigravityEditorContext FAntigravityEditorContextCapture::CaptureContext()
{
	FAntigravityEditorContext Ctx;
...
FString FAntigravityEditorContextCapture::BuildContextString()
{
	FAntigravityEditorContext Ctx = CaptureContext();
