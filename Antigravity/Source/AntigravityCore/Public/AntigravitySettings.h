...
public:
	 ...
	 *  Antigravity supports Anthropic (Claude), OpenAI (GPT/o-series), Google (Gemini),
	...
	EAntigravityProvider ActiveProvider;

	// ============================================================================
	// Anthropic (Claude) â€” legacy / primary provider fields
	// ============================================================================
	...
	EAntigravityContextWindow ContextWindow;
	...
	/** OpenAI model ID â€” select from the dropdown or type a custom model ID */
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "API|OpenAI",
	 ...
	 *  Do NOT use this for Azure â€” use the 'Azure OpenAI' provider instead. */
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "API|OpenAI",
	...
	EAntigravityReasoningEffort OpenAiReasoningEffort;
	...
	//
	// Ported from Roo Code openai.ts â€” AzureOpenAI client detection via _isAzureOpenAI()
	// ============================================================================

	/** Azure OpenAI API key. Get this from Azure portal â†’ your resource â†’ Keys and Endpoint.
	...
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "API|Azure OpenAI",
		...
		ToolTip = "Your Azure OpenAI resource key from Azure portal.\nGet it from: Azure portal â†’ OpenAI resource â†’ Resource Management â†’ Keys and Endpoint"))
	FString AzureApiKey;
	...
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "API|Azure OpenAI",
		...
		ToolTip = "Your Azure OpenAI resource endpoint.\nFormat: https://{resource-name}.openai.azure.com\nFind it in: Azure portal â†’ OpenAI resource â†’ Resource Management â†’ Keys and Endpoint"))
	...
	/** Gemini model â€” select from the dropdown or type a custom model ID */
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "API|Google Gemini",
	...
	EAntigravityReasoningEffort GeminiReasoningEffort;
	...
	/** DeepSeek model â€” select from the dropdown or type a custom model ID */
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "API|DeepSeek",
	...
	/** Mistral model â€” select from the dropdown or type a custom model ID */
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "API|Mistral",
	...
	/** xAI model â€” select from the dropdown or type a custom model ID */
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "API|xAI",
	...
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "API|LM Studio",
		...
		ToolTip = "No API key needed â€” LM Studio runs locally on your machine.\nDefault: http://localhost:1234\n\nSetup:\n1. Download LM Studio from https://lmstudio.ai\n2. Load a model in LM Studio\n3. Enable 'Local Server' in LM Studio (starts on port 1234)\n4. Select 'LM Studio (Local)' as your provider in Antigravity"))
	 ...
	 *  When true, ONLY AdditionalProtectedPaths is used â€” use with caution. */
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Safety|Protected Files",
	...
	static FString ModelEnumToApiString(EAntigravityClaudeModel Model);
	bool IsToolCategoryAllowed(EAntigravityActionCategory Category) const;
